...
class Azad_Register_Elementor_Widgets {
    ...
    public function widgets_registered() {
        if ( defined( 'ELEMENTOR_PATH' ) && class_exists( 'Elementor\Widget_Base' ) ) {
            $widgets_file = get_template_directory() . '/inc/Azad_Register_Elementor_Widgets.php';
            $template_file = locate_template( $widgets_file );
            if ( ! $template_file || ! is_readable( $template_file ) ) {
                $template_file = get_template_directory() . '/inc/Azad_Register_Elementor_Widgets.php';
            }
            if ( $template_file || is_readable( $template_file ) ) {
...
if ( ! function_exists( 'azad_elementor' ) ) {
    function azad_elementor(){
        Azad_Register_Elementor_Widgets::get_instance()->init();
    }
}
